...
const getExchangeRate = async (fromCurrency, toCurrency) => {
  try {
    const response = await axios.get('http://www.apilayer.net/api/live?access_key=a0e2cba4cdf423d0e79ea5a6e6ef9cff');
...
const convertCurrency = async(fromCurrency, toCurrency, amount) => {
  ...
  result.innerHTML = `${amount} ${fromCurrency} is worth ${convertedAmount} ${toCurrency}. You
